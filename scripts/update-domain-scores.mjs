...
const SCORES = {
  ...
  'boringssl-inspector': [9.1, 'Phase 0 honesty fix: decryptPayload stub removed, 65 tests'],
  browser: [8.9, 'largest domain, 77 tests, prior audit'],
  canvas: [9.3, 'Phase 0: Three.js + Babylon adapters, honest Unity message, 474 tests'],
  ...
  'exploit-dev': [9.3, '20 tests, Phase 0 capstone x64 one-gadget scan, CLAUDE.md created'],
  ...
  memory: [
    9.7,
    '34 tools, 50 tests, E5 parity, Phase 0 find_accesses wired readMemory+capstone+pid',
  ],

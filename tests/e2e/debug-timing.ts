...
const TOOLS = [
  ...
  ['breakpoint', { action: 'set', type: 'exception', state: 'all' }],
  ['breakpoint', { action: 'set', type: 'code', url: TARGET, lineNumber: 1 }],
  ['breakpoint', { action: 'list', type: 'code' }],
  ['breakpoint', { action: 'remove', type: 'code', breakpointId: '__placeholder__' }],
  ['breakpoint', { action: 'set', type: 'xhr', urlPattern: '/api/' }],
  ['breakpoint', { action: 'list', type: 'xhr' }],
  ['breakpoint', { action: 'remove', type: 'xhr', breakpointId: '0' }],
  ['breakpoint', { action: 'set', type: 'event', eventName: 'click' }],
  ['breakpoint', { action: 'set', type: 'event_category', category: 'mouse' }],
  ['breakpoint', { action: 'list', type: 'event' }],
  ['breakpoint', { action: 'remove', type: 'event', breakpointId: '0' }],
  ['watch', { action: 'add', expression: 'window.location.href' }],
  ['watch', { action: 'list' }],
  ['watch', { action: 'evaluate_all' }],
  ['watch', { action: 'remove', watchId: '0' }],
